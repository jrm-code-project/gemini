...
(defun file->blob (path)
  ...
  (handler-case
    ...
    (file-error (e)
      (log-warn "Error reading file ~a: ~a" path e)
      nil)
    (error (e)
      (log-warn "Error encoding file ~a: ~a" path e)
      nil)))
...
(defun blob->file (path bytes)
  ...
  (handler-case
    ...
    (file-error (e)
      (log-warn "Error writing file ~a: ~a" path e)
      nil)
    (error (e)
      (log-warn "Error decoding blob for file ~a: ~a" path e)
      nil)))
