...
(defun improve-system-instruction-with-session (session system-instruction &optional
...
(defun improve-system-instruction (system-instruction &optional
                                                        (improve-system-instruction-system-instruction
                                                        *improve-system-instruction-system-instruction*))
  (improve-system-instruction-with-session (ensure-runtime-session)
                                           system-instruction
                                           improve-system-instruction-system-instruction))
...
(defun weaken-system-instruction-with-session (session system-instruction)
  (let ((*system-instruction* (content :parts (list (part *improve-system-instruction-system-instruction*))
                                       :role "system")))
    (without-personality
      (invoke-gemini-with-session session
...
(defun weaken-system-instruction (system-instruction)
  (weaken-system-instruction-with-session (ensure-runtime-session) system-instruction))
...
(defun strengthen-system-instruction-with-session (session system-instruction)
  (let ((*system-instruction* (content :parts (list (part *improve-system-instruction-system-instruction*))
                                       :role "system")))
    (without-personality
      (invoke-gemini-with-session session
...
(defun strengthen-system-instruction (system-instruction)
  (strengthen-system-instruction-with-session (ensure-runtime-session) system-instruction))
...
(defun improve-prompt-with-session (session prompt &optional
...
(defun improve-prompt (prompt &optional
                                ...
                                *improve-prompt-prompt*)
                                (improve-prompt-system-instruction
                                *improve-prompt-system-instruction*))
  (improve-prompt-with-session (ensure-runtime-session)
                               prompt
                               improve-prompt-prompt
                               improve-prompt-system-instruction))
...
(defun condense-prompt-with-session (session prompt &optional
...
(defun condense-prompt (prompt &optional
                                (system-instruction +condense-prompt-system-instruction+)
                                (condense-prompt +condense-prompt-prompt+))
  (condense-prompt-with-session (ensure-runtime-session)
                                prompt
                                system-instruction
                                condense-prompt))
